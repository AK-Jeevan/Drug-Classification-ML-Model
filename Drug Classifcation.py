# This model is used to predict the accurate drug based on the patient symptoms using Logistic Regression.
...
data = pd.read_csv("C://Users//akjee//Documents//ML//Drug_dataset.csv")
...
print("Model Coefficients:", model.coef_)  # Print the coefficients of the model
